...
public interface CommentDao {
     ...
     * @return 评论总条数
     */
    Long findByVideoIdCounts(@Param("id") Integer videoId);
     ...
     * @return 评论列表
     */
    List<Comment> findByVideoId(@Param("id") Integer videoId, @Param("start") int start, @Param("rows") Integer rows);
